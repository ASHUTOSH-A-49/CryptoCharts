...
const CryptoDetails = () => {
  ...
  const { data: coinHistory, isLoading: historyLoading } = useGetCryptoHistoryQuery({ coinId, timePeriod });

  if (isFetching || historyLoading) return <Loader />;

  if (error) {
    console.error(error);
    return <div>Error fetching crypto details.</div>;
  }
      ...
      <Col className="stats-container">
        <Col className="coin-value-statistics">
          <Col className="coin-value-statistics-heading">
            ...
            <p>An overview showing stats such as base & quote currency, rank, and trading volume.</p>
          </Col>
        ...
        <Col className="other-stats-info">
          <Col className="coin-value-statistics-heading">
            ...
            <p>Additional details about {cryptoDetails.name} supply and exchanges.</p>
          </Col>
